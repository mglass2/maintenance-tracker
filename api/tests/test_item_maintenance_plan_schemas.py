"""Unit tests for item maintenance plan Pydantic schemas."""
...
class TestItemMaintenancePlanCreateRequest:
    """Tests for ItemMaintenancePlanCreateRequest schema."""
    ...
    def test_valid_request_minimal(self):
        ...
        request = ItemMaintenancePlanCreateRequest(**data)
    ...
    def test_missing_item_id(self):
        """Test missing item_id raises ValidationError."""
        data = {
            "task_type_id": 1,
            "time_interval_days": 30,
        }
        with pytest.raises(ValidationError) as exc_info:
            ItemMaintenancePlanCreateRequest(**data)
    ...
    def test_negative_item_id(self):
        """Test negative item_id raises ValidationError."""
        data = {
            "item_id": -1,
            "task_type_id": 1,
            "time_interval_days": 30,
    ...
    def test_zero_item_id(self):
        """Test zero item_id raises ValidationError."""
        data = {
            "item_id": 0,
            "task_type_id": 1,
            "time_interval_days": 30,
    ...
    def test_non_integer_item_id(self):
        """Test non-integer item_id raises ValidationError."""
        data = {
            "item_id": "not_an_int",
            "task_type_id": 1,
            "time_interval_days": 30,
...
class TestItemMaintenancePlanResponse:
    """Tests for ItemMaintenancePlanResponse schema."""
    ...
    def test_response_from_dict(self):
        ...
        response = ItemMaintenancePlanResponse(**data)
